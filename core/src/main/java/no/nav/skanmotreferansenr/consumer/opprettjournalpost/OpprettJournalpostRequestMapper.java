...
import no.nav.skanmotreferansenr.consumer.opprettjournalpost.data.AvsenderMottaker;
import no.nav.skanmotreferansenr.consumer.opprettjournalpost.data.Bruker;
